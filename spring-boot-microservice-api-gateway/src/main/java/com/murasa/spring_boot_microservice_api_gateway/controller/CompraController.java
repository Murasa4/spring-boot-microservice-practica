...
import com.murasa.spring_boot_microservice_api_gateway.request.CompraServiceRequest;
...
public class CompraController {
    ...
    @GetMapping
    public ResponseEntity<?> getAllCompraOfUser(@AuthenticationPrincipal UserPrincipal userPrincipal) {
